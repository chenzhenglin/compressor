        ...
        <el-row>
            <el-form ref="form" :rules="rules" :model="sizeForm" label-width="80px" size="medium">
                <el-row type="flex" justify="center">
                    <el-col :span="12">
                        <el-form-item label-width="100px" label="被压缩文件夹">
                            <el-input @input="onInputSelectDir" prop="selectFiles" placeholder="请输入被压缩文件夹路径"
                ...
                <el-row type="flex" justify="center">
                    <el-col :span="12">
                        <el-form-item label-width="100px" label="还原文件保存">
                            <el-input prop="savePath"  placeholder="请输入需要还原文件保存路径" v-model="sizeForm.buildSaveDir">
                ...
                <el-row type="flex" justify="center">
                    <el-col :span="12">
                        <el-form-item label-width="100px" label="备份文件路径">
                            <el-input prop="savePath" placeholder="请输入备份文件路径" v-model="sizeForm.srcSaveDir">
